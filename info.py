...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://worksoheb:worksoheb@autofiltermbbot.yskcmue.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://filestorebot-p91t.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filestorebot-p91t.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filestorebot-p91t.onrender.com/".format(FQDN)
else:
    URL = "https://filestorebot-p91t.onrender.com/".format(FQDN)
...
DOWNLOAD_TEXT_NAME = "📥 PREMIUM APP VIDEOS 📥"
DOWNLOAD_TEXT_URL = "https://t.me/Mdisk_Blast_Membership"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/mdiskblast_Botz"
